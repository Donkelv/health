...
class _TopHomeState extends State<TopHome> {
    ...
    return Column(
      ...
      children: [
        ...
        Text(
          "Today's Highlights",
          style: TextStyle(
              color: Colors.black, fontWeight: FontWeight.bold, fontSize: 13.0),
        ),
        Padding(
  ...
  BarChartData mainData(WalkNotifier provider) => BarChartData(
        barTouchData: BarTouchData(
            ...
            touchCallback: (barTouch) {
              setState(() {
                if (barTouch.spot != null &&
                    barTouch.touchInput is! FlPanEnd &&
                    barTouch.touchInput is! FlLongPressEnd) {
  ...
  List<BarChartGroupData> showingGroups(WalkNotifier provider) =>
      List.generate(7, (index) {
        switch (index) {
          case 0:
            return makeGroupData(
                0,
                provider.sundayWalk == null
                    ? 0.0
                    : provider.sundayWalk.toDouble(),
                isTouched: index == touchedIndex);
          case 1:
            return makeGroupData(
                1,
                provider.mondayWalk == null
                    ? 0.0
                    : provider.mondayWalk.toDouble(),
                isTouched: index == touchedIndex);
          case 2:
            return makeGroupData(
                2,
                provider.tuesdayWalk == null
                    ? 0.0
                    : provider.tuesdayWalk.toDouble(),
                isTouched: index == touchedIndex);
          case 3:
            return makeGroupData(
                3,
                provider.wednesdayWalk == null
                    ? 0.0
                    : provider.wednesdayWalk.toDouble(),
                isTouched: index == touchedIndex);
          case 4:
            return makeGroupData(
                4,
                provider.thusdayWalk == null
                    ? 0.0
                    : provider.thusdayWalk.toDouble(),
                isTouched: index == touchedIndex);
          case 5:
            return makeGroupData(
                5,
                provider.fridayWalk == null
                    ? 0.0
                    : provider.fridayWalk.toDouble(),
                isTouched: index == touchedIndex);
          case 6:
            return makeGroupData(
                6,
                provider.saturdayWalk == null
                    ? 0.0
                    : provider.saturdayWalk.toDouble(),
                isTouched: index == touchedIndex);
          default:
            return null;
        }
